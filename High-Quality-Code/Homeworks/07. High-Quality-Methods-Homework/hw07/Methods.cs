    ...
    class Methods
    {
        ...
        static string NumberToDigit(int number)
        {
            switch (number)
            {
                ...
                case 8: return "eight";
                case 9: return "nine";
                default: throw new ArgumentException("The numbers should be in [0-9] range.");
            }
        }
        ...
        static int FindMax(params int[] elements)
        {
            ...
            {
                throw new ArgumentException("There have to be at least 1 number in the array");
            }
        ...
        static void PrintAsNumber(object number, string format)
        {
            switch (format)
            {
                ...
                case "r": Console.WriteLine("{0,8}", number);
                    break;
                default: throw new ArgumentException("Formats have to be one of the following (f, %, r).");
            }
        }
