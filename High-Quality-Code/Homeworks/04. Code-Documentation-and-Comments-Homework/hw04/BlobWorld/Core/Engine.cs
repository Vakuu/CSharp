namespace BlobWorld.Core
{
    ...
    public class Engine : IRunnable
    {
        ...
        /// 
        /// </summary>
        /// <param name="reader">Input Interface, from where to read</param>
        /// <param name="writer">Output Interface, where to send</param>
        /// <param name="data">List in which new Blobs to be added and updated</param>
        public Engine(
            IInputReader reader,
