...
namespace CohesionAndCoupling
{
    class UtilsExamples
    {
        static void Main()
        {
            Console.WriteLine(GetFileNameParts.GetFileExtension("example"));
            Console.WriteLine(GetFileNameParts.GetFileExtension("example.pdf"));
            Console.WriteLine(GetFileNameParts.GetFileExtension("example.new.pdf"));

            Console.WriteLine(GetFileNameParts.GetFileNameWithoutExtension("example"));
            Console.WriteLine(GetFileNameParts.GetFileNameWithoutExtension("example.pdf"));
            Console.WriteLine(GetFileNameParts.GetFileNameWithoutExtension("example.new.pdf"));
